...
{
    //public class AddDiplomaCommandHandler:IRequestHandler<AddDiplomaCommand,Unit>
    //{
    //    #region Fields
    ...
    //    #region Operation 
    //    public async Task<uint> Handle(AddDiplomaCommand command, CancellationToken cancellationToken)
    //    {
